...
{
    /// <summary>
    /// This object describes (URL encoded parameter) post data, if any (embedded in request object).
    /// </summary>
    /// <remarks>
    /// https://github.com/ahmadnassri/har-spec/blob/master/versions/1.3.md#postdata
    /// </remarks>
    public class ParamsPostData : PostData
    {
        /// <summary>
        /// Creates a default/empty post data object (with text)
        /// </summary>
        /// <returns></returns>
        public ParamsPostData() : this("", null)
        {
        ...
        public ParamsPostData(string mimeType, IEnumerable<PostDataParam>? @params) : base(mimeType: mimeType)
        {
